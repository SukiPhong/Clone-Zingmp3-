        ...
        <div>
            ...
            <div className="flex flex-col gap-1 items-center ">
                ...
                <span className="text-gray-500 text-xs">
                    <span>Cập nhật:&nbsp;</span>
                    <span>{moment.unix(contentLastUpdate).format('DD/MM/YYYY')}</span>
                </span>
                <span className="text-center text-gray-500 gap-2  text-xs flex items-center">
                    {artistsNames}
                </span>
                <span className="flex items-center text-gray-500  gap-2 text-xs pb-4">{`${Math.round(
                    likes / 1000,
